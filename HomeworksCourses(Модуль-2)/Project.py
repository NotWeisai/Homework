...
Original file is located at
    https://colab.research.google.com/drive/1DpGgJ6iXEMa84XcFaaQkknEZFmq--Mf0
"""
...
plt.hist(data1, bins = 30, color='green', alpha=0.5, label = 'Наличие кондиционеров')     # В разные переменные кладу данные о наличии/отсутствии кондиционеров, обозначаю их разными цветами и подписываю.
